...
import {
  ...
  SiMongodb, SiNeo4j,
  SiGooglecloud, SiFirebase, SiDocker, SiGit
} from 'react-icons/si';
...
export const skills = {
  ...
  "Frameworks & Libraries": [
    ...
    // { name: "gRPC", icon: <SiGrpc className="text-green-400" /> },
    // { name: "Protobuf", icon: <SiProtobuf className="text-blue-400" /> },
  ...
  "Databases": [
    ...
    { name: "AWS Keyspaces", icon: <FaAws className="text-orange-500" /> }
  ],
  "Cloud & DevOps": [
